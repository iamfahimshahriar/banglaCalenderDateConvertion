...
cellpadding="0" border="'+brdr+'" cellspacing="0"><tr align="center"><td colspan="2">'+
beng_bc_month_name[bcal1[1]]+'</td><td colspan="3">'+ byy + '</td><td colspan="2">' + 
beng_bc_month_name[bcal[1]] + '</td><tr align="center">';
t+='<td colspan="7" align="center" class="'+cH+'">'+mn[m-1]+' - '+y+'</td></tr><tr align="center">';
t+='<tr align="center"><td>রবি</td>    <td>সোম</td><td>মঙ্গল</td><td>বুধ</td><td>বৃহঃ</td>
<td>শুক্র</td><td>শনি</td></tr><tr align="center">';
...
   html += '<tr>';
   for (var i = 0; i <= 6; i++) {
       html += '<td style=\"color: red; background: #99ff66; border: 1px solid black; 
               font: 12px Siyam Rupali;\">';
...
//var date = new Date(Date.UTC(2017, 05, 08, 3, 0, 0));

// formats below assume the local time zone of the locale;
// America/Los_Angeles for the US

// US English uses month-day-year order
//console.log(date.toLocaleDateString('bn'));
...
var banglaDate = convertToBanglaDate(2017, 5, 8);
document.getElementById("demo").innerHTML = banglaDate;
</script>
